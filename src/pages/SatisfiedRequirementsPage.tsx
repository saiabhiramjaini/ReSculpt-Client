...
export const SatisfiedRequirements = () => {
  ...
  const makePayment = async (requirement: AddWasteRequirementInput) => {
    ...
    try {
      const product = {
        ...
        quantity: requirement.initialQuantity,
      };
  ...
  return (
    <div>
      {loading ? (
        <Loading />
      ) : wasteRequirement && wasteRequirement.length > 0 ? (
            ...
            <div className="col-span-4 pt-8 lg:pt-0">
              ...
              <div className="">
                <ul className="space-y-5 pb-1 text-sm">
                  ...
                  <button
                    type="button"
                    onClick={() => makePayment(requirement)}
              ...
              <div className="mb-4 mt-4">
                ...
                <ul className="colors -mr-3 flex flex-wrap">
                  ...
                  <li className="text-heading mb-2 mr-2 flex h-9 w-9 cursor-pointer items-center justify-center p-1 text-xs font-semibold uppercase transition duration-200 ease-in-out md:mb-3 md:mr-3 md:h-11 md:w-11 md:text-sm">
                    X
                  </li>
        ...
        <NoData text="No satisfied waste requirements found." />
      )}
    </div>
  );
};
